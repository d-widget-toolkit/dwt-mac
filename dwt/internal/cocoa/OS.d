...
public class OS : C {
    ...
    public static /+const+/ objc.Class class_WebPanelAuthenticationHandler;
...
alias Cocoa.ATSFontContext.kATSFontContextLocal kATSFontContextLocal;
public static const int kATSOptionFlagsDefault = 0;
alias Cocoa.ATSFontFormat.kATSFontFilterCurrentVersion kATSFontFormatUnspecified;
...
alias Cocoa.CGBitmapInfo.kCGBitmapByteOrderDefault kCGBitmapByteOrderDefault;
alias Cocoa.CGBitmapInfo.kCGBitmapByteOrder16Little kCGBitmapByteOrder16Little;
alias Cocoa.CGBitmapInfo.kCGBitmapByteOrder32Little kCGBitmapByteOrder32Little;
alias Cocoa.CGBitmapInfo.kCGBitmapByteOrder16Big kCGBitmapByteOrder16Big;
alias Cocoa.CGBitmapInfo.kCGBitmapByteOrder32Big kCGBitmapByteOrder32Big;
public static const Cocoa.CGBitmapInfo kCGBitmapByteOrder16Host = __BIG_ENDIAN__ ? kCGBitmapByteOrder16Big : kCGBitmapByteOrder16Little;
public static const Cocoa.CGBitmapInfo kCGBitmapByteOrder32Host = __BIG_ENDIAN__ ? kCGBitmapByteOrder32Big : kCGBitmapByteOrder32Little;
...
public static /+const+/ objc.Class class_DOMEvent;
public static /+const+/ objc.Class class_DOMKeyboardEvent;
public static /+const+/ objc.Class class_DOMMouseEvent;
public static /+const+/ objc.Class class_DOMUIEvent;
public static /+const+/ objc.Class class_DOMWheelEvent;
public static /+const+/ objc.Class class_NSActionCell;
public static /+const+/ objc.Class class_NSAffineTransform;
public static /+const+/ objc.Class class_NSAlert;
public static /+const+/ objc.Class class_NSAppleEventDescriptor;
public static /+const+/ objc.Class class_NSApplication;
public static /+const+/ objc.Class class_NSArray;
public static /+const+/ objc.Class class_NSAttributedString;
public static /+const+/ objc.Class class_NSAutoreleasePool;
public static /+const+/ objc.Class class_NSBezierPath;
public static /+const+/ objc.Class class_NSBitmapImageRep;
public static /+const+/ objc.Class class_NSBox;
public static /+const+/ objc.Class class_NSBrowserCell;
public static /+const+/ objc.Class class_NSBundle;
public static /+const+/ objc.Class class_NSButton;
public static /+const+/ objc.Class class_NSButtonCell;
public static /+const+/ objc.Class class_NSCalendarDate;
public static /+const+/ objc.Class class_NSCell;
public static /+const+/ objc.Class class_NSCharacterSet;
public static /+const+/ objc.Class class_NSClipView;
public static /+const+/ objc.Class class_NSCoder;
public static /+const+/ objc.Class class_NSColor;
public static /+const+/ objc.Class class_NSColorPanel;
public static /+const+/ objc.Class class_NSColorSpace;
public static /+const+/ objc.Class class_NSComboBox;
public static /+const+/ objc.Class class_NSComboBoxCell;
public static /+const+/ objc.Class class_NSControl;
public static /+const+/ objc.Class class_NSCursor;
public static /+const+/ objc.Class class_NSData;
public static /+const+/ objc.Class class_NSDate;
public static /+const+/ objc.Class class_NSDatePicker;
public static /+const+/ objc.Class class_NSDictionary;
public static /+const+/ objc.Class class_NSDirectoryEnumerator;
public static /+const+/ objc.Class class_NSEnumerator;
public static /+const+/ objc.Class class_NSError;
public static /+const+/ objc.Class class_NSEvent;
public static /+const+/ objc.Class class_NSFileManager;
public static /+const+/ objc.Class class_NSFileWrapper;
public static /+const+/ objc.Class class_NSFont;
public static /+const+/ objc.Class class_NSFontManager;
public static /+const+/ objc.Class class_NSFontPanel;
public static /+const+/ objc.Class class_NSFormatter;
public static /+const+/ objc.Class class_NSGradient;
public static /+const+/ objc.Class class_NSGraphicsContext;
public static /+const+/ objc.Class class_NSHTTPCookie;
public static /+const+/ objc.Class class_NSHTTPCookieStorage;
public static /+const+/ objc.Class class_NSImage;
public static /+const+/ objc.Class class_NSImageRep;
public static /+const+/ objc.Class class_NSImageView;
public static /+const+/ objc.Class class_NSIndexSet;
public static /+const+/ objc.Class class_NSInputManager;
public static /+const+/ objc.Class class_NSKeyedArchiver;
public static /+const+/ objc.Class class_NSKeyedUnarchiver;
public static /+const+/ objc.Class class_NSLayoutManager;
public static /+const+/ objc.Class class_NSMenu;
public static /+const+/ objc.Class class_NSMenuItem;
public static /+const+/ objc.Class class_NSMutableArray;
public static /+const+/ objc.Class class_NSMutableAttributedString;
public static /+const+/ objc.Class class_NSMutableDictionary;
public static /+const+/ objc.Class class_NSMutableIndexSet;
public static /+const+/ objc.Class class_NSMutableParagraphStyle;
public static /+const+/ objc.Class class_NSMutableSet;
public static /+const+/ objc.Class class_NSMutableString;
public static /+const+/ objc.Class class_NSMutableURLRequest;
public static /+const+/ objc.Class class_NSNotification;
public static /+const+/ objc.Class class_NSNotificationCenter;
public static /+const+/ objc.Class class_NSNumber;
public static /+const+/ objc.Class class_NSNumberFormatter;
public static /+const+/ objc.Class class_NSObject;
public static /+const+/ objc.Class class_NSOpenGLContext;
public static /+const+/ objc.Class class_NSOpenGLPixelFormat;
public static /+const+/ objc.Class class_NSOpenPanel;
public static /+const+/ objc.Class class_NSOutlineView;
public static /+const+/ objc.Class class_NSPanel;
public static /+const+/ objc.Class class_NSParagraphStyle;
public static /+const+/ objc.Class class_NSPasteboard;
public static /+const+/ objc.Class class_NSPopUpButton;
public static /+const+/ objc.Class class_NSPrintInfo;
public static /+const+/ objc.Class class_NSPrintOperation;
public static /+const+/ objc.Class class_NSPrintPanel;
public static /+const+/ objc.Class class_NSPrinter;
public static /+const+/ objc.Class class_NSProgressIndicator;
public static /+const+/ objc.Class class_NSResponder;
public static /+const+/ objc.Class class_NSRunLoop;
public static /+const+/ objc.Class class_NSSavePanel;
public static /+const+/ objc.Class class_NSScreen;
public static /+const+/ objc.Class class_NSScrollView;
public static /+const+/ objc.Class class_NSScroller;
public static /+const+/ objc.Class class_NSSearchField;
public static /+const+/ objc.Class class_NSSearchFieldCell;
public static /+const+/ objc.Class class_NSSecureTextField;
public static /+const+/ objc.Class class_NSSegmentedCell;
public static /+const+/ objc.Class class_NSSet;
public static /+const+/ objc.Class class_NSSlider;
public static /+const+/ objc.Class class_NSStatusBar;
public static /+const+/ objc.Class class_NSStatusItem;
public static /+const+/ objc.Class class_NSStepper;
public static /+const+/ objc.Class class_NSString;
public static /+const+/ objc.Class class_NSTabView;
public static /+const+/ objc.Class class_NSTabViewItem;
public static /+const+/ objc.Class class_NSTableColumn;
public static /+const+/ objc.Class class_NSTableHeaderCell;
public static /+const+/ objc.Class class_NSTableHeaderView;
public static /+const+/ objc.Class class_NSTableView;
public static /+const+/ objc.Class class_NSText;
public static /+const+/ objc.Class class_NSTextAttachment;
public static /+const+/ objc.Class class_NSTextContainer;
public static /+const+/ objc.Class class_NSTextField;
public static /+const+/ objc.Class class_NSTextFieldCell;
public static /+const+/ objc.Class class_NSTextStorage;
public static /+const+/ objc.Class class_NSTextTab;
public static /+const+/ objc.Class class_NSTextView;
public static /+const+/ objc.Class class_NSThread;
public static /+const+/ objc.Class class_NSTimeZone;
public static /+const+/ objc.Class class_NSTimer;
public static /+const+/ objc.Class class_NSToolbar;
public static /+const+/ objc.Class class_NSToolbarItem;
public static /+const+/ objc.Class class_NSTrackingArea;
public static /+const+/ objc.Class class_NSTypesetter;
public static /+const+/ objc.Class class_NSURL;
public static /+const+/ objc.Class class_NSURLAuthenticationChallenge;
public static /+const+/ objc.Class class_NSURLCredential;
public static /+const+/ objc.Class class_NSURLDownload;
public static /+const+/ objc.Class class_NSURLProtectionSpace;
public static /+const+/ objc.Class class_NSURLRequest;
public static /+const+/ objc.Class class_NSValue;
public static /+const+/ objc.Class class_NSView;
public static /+const+/ objc.Class class_NSWindow;
public static /+const+/ objc.Class class_NSWorkspace;
public static /+const+/ objc.Class class_WebDataSource;
public static /+const+/ objc.Class class_WebFrame;
public static /+const+/ objc.Class class_WebFrameView;
public static /+const+/ objc.Class class_WebPreferences;
public static /+const+/ objc.Class class_WebScriptObject;
public static /+const+/ objc.Class class_WebUndefined;
public static /+const+/ objc.Class class_WebView;
...
public static /+const+/ objc.SEL sel_glyphIndexForPoint_inTextContainer_fractionOfDistanceThroughGlyph__actualCharacterRange_;
...
alias Cocoa.NSBorderType.NSBezelBorder NSBezelBorder;
alias Cocoa.NSFontTraitMask.NSBoldFontMask NSBoldFontMask;
...
alias dwt.internal.cocoa.NSBox.NSBoxCustom NSBoxCustom;
alias dwt.internal.cocoa.NSBox.NSBoxSeparator NSBoxSeparator;
...
alias Cocoa.NSClosableWindowMask NSClosableWindowMask;
...
alias Cocoa.NSCompositingOperation.NSCompositeCopy NSCompositeCopy;
...
alias Cocoa.NSFontTraitMask.NSItalicFontMask NSItalicFontMask;
...
alias Cocoa.NSPrintingOrientation.NSLandscapeOrientation NSLandscapeOrientation;
...
alias Cocoa.NSMiniaturizableWindowMask NSMiniaturizableWindowMask;
...
alias Cocoa.NSBorderType.NSNoBorder NSNoBorder;
...
alias Cocoa.NSOpenGLPixelFormatAttribute.NSOpenGLPFAAccumSize NSOpenGLPFAAccumSize;
alias Cocoa.NSOpenGLPixelFormatAttribute.NSOpenGLPFAAlphaSize NSOpenGLPFAAlphaSize;
alias Cocoa.NSOpenGLPixelFormatAttribute.NSOpenGLPFAColorSize NSOpenGLPFAColorSize;
...
alias Cocoa.NSPrintingOrientation.NSPortraitOrientation NSPortraitOrientation;
...
alias Cocoa.NSResizableWindowMask NSResizableWindowMask;
...
alias Cocoa.NSScrollerPart.NSScrollerDecrementLine NSScrollerDecrementLine;
alias Cocoa.NSScrollerPart.NSScrollerDecrementPage NSScrollerDecrementPage;
alias Cocoa.NSScrollerPart.NSScrollerIncrementLine NSScrollerIncrementLine;
alias Cocoa.NSScrollerPart.NSScrollerIncrementPage NSScrollerIncrementPage;
alias Cocoa.NSScrollerPart.NSScrollerKnob NSScrollerKnob;
...
alias Cocoa.NSControlSize.NSSmallControlSize NSSmallControlSize;
...
alias Cocoa.NSTableViewDropOperation.NSTableViewDropAbove NSTableViewDropAbove;
alias Cocoa.NSTableViewDropOperation.NSTableViewDropOn NSTableViewDropOn;
...
alias Cocoa.NSTitledWindowMask NSTitledWindowMask;
...
alias Carbon.CFRunLoopActivity.kCFRunLoopBeforeWaiting kCFRunLoopBeforeWaiting;
public static const int kCFStringEncodingUTF8 = 134217984;
alias Cocoa.CGBlendMode.kCGBlendModeDifference kCGBlendModeDifference;
...
public static const Cocoa.CGBitmapInfo kCGImageAlphaFirst = cast(Cocoa.CGBitmapInfo)4;
public static const Cocoa.CGBitmapInfo kCGImageAlphaLast = cast(Cocoa.CGBitmapInfo)3;
public static const Cocoa.CGBitmapInfo kCGImageAlphaNoneSkipFirst = cast(Cocoa.CGBitmapInfo)6;
public static const Cocoa.CGBitmapInfo kCGImageAlphaNoneSkipLast = cast(Cocoa.CGBitmapInfo)5;
public static const Cocoa.CGBitmapInfo kCGImageAlphaOnly = cast(Cocoa.CGBitmapInfo)7;
alias Cocoa.CGEventField.kCGKeyboardEventKeyboardType kCGKeyboardEventKeyboardType;
alias Cocoa.CGLineCap.kCGLineCapButt kCGLineCapButt;
alias Cocoa.CGLineCap.kCGLineCapRound kCGLineCapRound;
alias Cocoa.CGLineCap.kCGLineCapSquare kCGLineCapSquare;
alias Cocoa.CGLineJoin.kCGLineJoinBevel kCGLineJoinBevel;
alias Cocoa.CGLineJoin.kCGLineJoinMiter kCGLineJoinMiter;
alias Cocoa.CGLineJoin.kCGLineJoinRound kCGLineJoinRound;
alias Cocoa.CGPathElementType.kCGPathElementAddCurveToPoint kCGPathElementAddCurveToPoint;
alias Cocoa.CGPathElementType.kCGPathElementAddLineToPoint kCGPathElementAddLineToPoint;
alias Cocoa.CGPathElementType.kCGPathElementAddQuadCurveToPoint kCGPathElementAddQuadCurveToPoint;
alias Cocoa.CGPathElementType.kCGPathElementCloseSubpath kCGPathElementCloseSubpath;
alias Cocoa.CGPathElementType.kCGPathElementMoveToPoint kCGPathElementMoveToPoint;
public static const int kCGPathStroke = 2;
alias Cocoa.CGEventTapLocation.kCGSessionEventTap kCGSessionEventTap;
...
alias Cocoa.NSComparisonResult.NSOrderedSame NSOrderedSame;
alias Cocoa.NSURLCredentialPersistence.NSURLCredentialPersistenceForSession NSURLCredentialPersistenceForSession;
public static const int NSURLErrorBadURL = -1000;
alias Cocoa.NSURLRequestCachePolicy.NSURLRequestReloadIgnoringLocalCacheData NSURLRequestReloadIgnoringLocalCacheData;
...
/**
 * @param path cast=(CGMutablePathRef)
 * @param m cast=(CGAffineTransform*)objc_msgSendSuper_bool
 * @param x cast=(CGFloat)
 * @param y cast=(CGFloat)
 */
...
static this () {
    ...
    sel_glyphIndexForPoint_inTextContainer_fractionOfDistanceThroughGlyph__actualCharacterRange_ = sel_registerName("glyphIndexForPoint:inTextContainer:fractionOfDistanceThroughGlyph:actualCharacterRange:");
