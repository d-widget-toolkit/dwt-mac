 ...
 *******************************************************************************/
module dwt.browser.BrowserFunction;
 ...
 * @see #dispose()
 * @see #function(Object[])
 * @see dwt.browser.LocationListener#changed(LocationEvent)
 *
 * @since 3.5
 */
...
BrowserFunction (Browser browser, String name, bool create) {
    super ();
    if (browser is null) DWT.error (DWT.ERROR_NULL_ARGUMENT);
    if (name is null) DWT.error (DWT.ERROR_NULL_ARGUMENT);
    if (browser.isDisposed ()) DWT.error (DWT.ERROR_WIDGET_DISPOSED);
    browser.checkWidget ();
 ...
 * javascript bool -> <code>java.lang.Boolean</code>
...
public Object function (Object[] arguments) {
    if (index < 0) DWT.error (DWT.ERROR_FUNCTION_DISPOSED);
    browser.checkWidget ();
    return null;
}
